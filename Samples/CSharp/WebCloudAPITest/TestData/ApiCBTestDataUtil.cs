...
namespace WebCloudAPITest.TestData
{
    ...
    {
        public void InvokeUploadFileAPI()
        {
            FileUploadForm UploadForm = new FileUploadForm(this);
            UploadForm.ShowDialog();
        }

        public void InvokeDownloadFileAPI()
        {
            FileDownloadForm DownloadForm = new FileDownloadForm(this);
        ...
        public void InvokeApplicationDataUploadForm()
        {
            new UploadAppDataForm(this).Show();
        }

        public void InvokeApplicationDataDownloadForm()
        {
            new DownloadAppDataForm(this).Show();
        }
