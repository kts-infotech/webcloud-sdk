...
namespace WebCloudAPITest
{
    ...
    public partial class ExamQuestionPaper : Form
    {
        ...
        /// 
        /// </summary>
        /// <param name="examInfoList"></param>
        /// <param name="obj"></param>
        public ExamQuestionPaper(List<object> examInfoList,string questions,ApiTestDataUtil obj)
        {
            InitializeComponent();
            objTestDataUtil = obj;
        ...
        public void PanelSettings()
        {
            ...
            vScrollBar1.Scroll += (sender, e) => { panelq.VerticalScroll.Value = vScrollBar1.Value; };
            panelq.Controls.Add(vScrollBar1);
        }
        ...
        public void LoadQuestions(string questions)
        {
            ...
            if(!(string.IsNullOrEmpty(questions)))
            {
                ...
                foreach (var question in xmlDoc.Descendants("CM_OL_EXAM_QUESTION_MASTER_TB"))
                {
                    ...
                    var control = new QuestionPaper(question, Qno);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        /* private void trvCategories_Click(object sender, EventArgs e)
         {
             //Find tag (id) of node which  is selected.
             int mainCategoryID = FindCheckedNodeId(trvCategories.Nodes);           
             objTestDataUtil.InvokeLoadQuestionPaperAPI(mainCategoryID);
         }*/
    }
}
